            ...
            <form method="post" action="{{ route('admin.student.store') }}" autocomplete="off">
                @csrf
                        ...
                        <div class="col-6">
                            <div class="form-group{{ $errors->has('jenkel') ? ' has-danger' : '' }}">
                                ...
                                <select name="jenkel" class="form-control">
                                    <option value="" id="gender">Pilih Jenis Kelamin Siswa</option>
                        ...
                        <div class="col-6">
                            <div class="form-group{{ $errors->has('class_id') ? ' has-danger' : '' }}">
                                ...
                                <select name="class_id" class="form-control">
                                    <option value="" id="class">Pilih Kelas Siswa</option>
                                    @foreach ($kelas as $k)
                        ...
                        <div class="col-6">
                            <div class="form-group{{ $errors->has('jurusan_id') ? ' has-danger' : '' }}">
                                ...
                                <select name="jurusan_id" id="" class="form-control">
                                    <option value="" id="major">Pilih Jurusan Siswa</option>
                    ...
                    <div class="form-group{{ $errors->has('alamat') ? ' has-danger' : '' }}">
                        ...
                        <textarea name="alamat" id="address" class="form-control" cols="30" rows="3"></textarea>
