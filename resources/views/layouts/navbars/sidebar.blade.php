    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{Request::segment(2) == 'student' ? 'active' : ''}}" href="{{route('admin.student.index')}}">
                        <i class="ni ni-planet text-blue"></i> {{ __('Siswa') }}
                    </a>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse show" id="navbar-examples">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.absensi.history') }}">
                                    {{ __('Riwayat Absensi') }}
                                </a>
                            </li>
                        </ul>
